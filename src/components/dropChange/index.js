...
export default class DropdownChange extends PureComponent {
  static defaultProps = {
  ...
  //   let {modal, width, top, left, leftInset, rightInset, selected} = nexState;
  ...
  renderBase(props,titleProps) {
    ...
    if (typeof renderBase === 'function') {
      return renderBase({...props, titleProps, value, renderAccessory});
    }
        ...
        <TouchableOpacity {...touchableProps}>
          <View
            ...
            <View
              ...
              {this.renderBase(props,titleProps)}
              {this.renderRipple()}
            </View>
          </View>
        </TouchableOpacity>
